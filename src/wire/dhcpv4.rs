...
mod test {
    ...
    static PXE_OFFER_BYTES: &[u8] = &[
        ,
    ];
    ...
    const fn pxe_offer_repr() -> Repr<'static> {
        const CLIENT_MAC: EthernetAddress = EthernetAddress([0x00, 0x01, 0x2e, 0x91, 0xf7, 0xfe]);
        const SERVER_IP: Ipv4Address = Ipv4Address([192, 168, 178, 65]);
        Repr {
            sname: Some("myserver.example.com"),
            boot_file: Some("http://192.168.178.65:80/_/ipxe?arch=0&mac=00:01:2e:91:f7:fe"),
            message_type: MessageType::Offer,
            transaction_id: 0x833f803f,
            ...
            lease_duration: None, // Infinite lease
            additional_options: &[],
        }
    }

    #[test]
    fn test_parse_pxe_offer() {
        let packet = Packet::new_unchecked(PXE_OFFER_BYTES);
        let repr = Repr::parse(&packet).unwrap();
        assert_eq!(repr, pxe_offer_repr());
    }

    #[test]
    fn test_emit_pxe_offer() {
        let repr = pxe_offer_repr();
        let mut bytes = vec![0xa5; repr.buffer_len()];
        let mut packet = Packet::new_unchecked(&mut bytes);
        repr.emit(&mut packet).unwrap();
        let packet = &*packet.into_inner();
        let packet_len = packet.len();
        assert_eq!(packet, &PXE_OFFER_BYTES[..packet_len]);
        for byte in &PXE_OFFER_BYTES[packet_len..] {
